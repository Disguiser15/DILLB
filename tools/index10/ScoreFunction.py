...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/index10/voc11_index10.json')
    parser.add_argument("--indicator-file",type=str,default='results/voc11_index10')
