...
with open('./datasets/two_stage_datasets/index10/exdark/annotations/exdark_train.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index10/semi/exdark_20%/annotations/exdark_train_20%.json', 'w'))