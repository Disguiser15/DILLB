...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index10/voc_07_12_11/Annotations/instances_trainval.json')
    parser.add_argument("--active-annotation", type=str, default='results/voc11_index10.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index10/semi/voc11_label/annotations/voc11_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index10/semi/voc11_unlabel/annotations/voc11_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index10/voc_07_12_11/JPEGImages/trainval/')
    parser.add_argument("--classes-number", type=str, default=11)
