...
def pick_dataset():
    ...
    json.dump(json_data_new, open(args.save_dir+'bdd_1%.json', 'w'))

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='pick dataset of specific percentage')
    parser.add_argument("--input-dir",type=str,default='./datasets/bdd100k/annotations/bdd100k_labels_images_det_coco_train.json')
    parser.add_argument("--save-dir",type=str,default='./datasets/index11/semi/bdd1%/annotations/')
