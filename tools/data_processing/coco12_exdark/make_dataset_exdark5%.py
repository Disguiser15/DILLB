...
def pick_dataset():
    ...
    json.dump(json_data_new, open(args.save_dir+'exdark_5%.json', 'w'))

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='pick dataset of specific percentage')
    parser.add_argument("--input-dir",type=str,default='./datasets/two_stage_datasets/index9/exdark/annotations/exdark_train.json')
    parser.add_argument("--save-dir",type=str,default='./datasets/index9/semi/exdark5%/annotations/')
    parser.add_argument("--pick-percent",type=float,default=0.05)
