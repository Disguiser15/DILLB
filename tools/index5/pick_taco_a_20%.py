...
with open('./datasets/two_stage_datasets/index5/taco_a/annotations/instances_train.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index5/semi/tacoa_20%/annotations/instance_train_20%.json', 'w'))