...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index5/taco_b/annotations/instances_train.json')
    parser.add_argument("--active-annotation", type=str, default='results/tacobtrain.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index5/semi/tacob_label/annotations/tacob_active_label.json')
    ...
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index5/taco_b/images/train/')
    parser.add_argument("--classes-number", type=str, default=13)
