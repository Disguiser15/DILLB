...
if __name__ == '__main__':
    ...
    parser.add_argument("--input-dir",type=str,default='output/index2/baseline/productline1_sup100/model_best.pth')
    parser.add_argument("--save-dir",type=str,default='output/index2/baseline/productline1_sup100/one_stage.pth')
