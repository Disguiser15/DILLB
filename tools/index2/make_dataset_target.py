...
def generate_active_label_data():
    ...
    newimgidlist = list()
    for i in tqdm(range(args.classes_number * 7)):
...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index2/productline2/train/annotations/instances_default_3cls.json')
    parser.add_argument("--active-annotation", type=str, default='results/productline2train.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index2/semi/productline2_label/annotations/productline2_active_label.json')
    # parser.add_argument("--output-dir2", type=str, default='datasets/index1/semi/coco20_unlabel/annotations/coco20_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index2/productline2/train/images/')
    parser.add_argument("--classes-number", type=str, default=3)
