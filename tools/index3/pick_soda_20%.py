...
with open('./datasets/two_stage_datasets/index3/soda_10m/annotations/instance_train.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index3/semi/soda_20%/annotations/instance_train_20%.json', 'w'))