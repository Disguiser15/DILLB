...
def generate_active_label_data():
    ...
    newimgidlist = list()
    for i in tqdm(range(args.classes_number * 99)):
...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index3/trafficrecoder/train/annotations/instances_default.json')
    parser.add_argument("--active-annotation", type=str, default='results/sodatrain.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index3/semi/trafficrecorder_label/annotations/trafficrecorder_active_label.json')
    # parser.add_argument("--output-dir2", type=str, default='datasets/index1/semi/coco20_unlabel/annotations/coco20_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index3/trafficrecoder/train/images/')
    parser.add_argument("--classes-number", type=str, default=6)
