...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index4/coco20_b/annotations/instances_train.json')
    parser.add_argument("--active-annotation", type=str, default='results/cocobtrain.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index4/semi/cocob_label/annotations/cocob_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index4/semi/cocob_unlabel/annotations/cocob_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index4/coco20_b/images/train/')
    parser.add_argument("--classes-number", type=str, default=20)
