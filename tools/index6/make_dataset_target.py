...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index6/voc_2012/Annotations/instances_train.json')
    parser.add_argument("--active-annotation", type=str, default='results/voc12_index6.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index6/semi/voc12_label/annotations/voc12_active_label.json')
    ...
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index6/voc_2012/JPEGImages/')
