...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/index6/voc12_index6.json')
    parser.add_argument("--indicator-file",type=str,default='results/voc12_index6')
