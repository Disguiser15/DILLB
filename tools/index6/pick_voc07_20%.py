...
with open('./datasets/two_stage_datasets/index6/voc_2007/Annotations/instances_train.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index6/semi/voc07_20%/annotations/instance_train_20%.json', 'w'))