...
with open('./datasets/two_stage_datasets/index7/voc07_12_5/Annotations/instances_trainval.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index7/semi/voc5_20%/annotations/instance_trainval_20%.json', 'w'))