...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/index7/coco5_index7.json')
    parser.add_argument("--indicator-file",type=str,default='results/coco5_index7')
