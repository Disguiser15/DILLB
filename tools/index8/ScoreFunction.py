...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/index8/object365_index8.json')
    parser.add_argument("--indicator-file",type=str,default='results/object365_index8')
