...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index8/objects365_5/Annotations/instances_train.json')
    parser.add_argument("--active-annotation", type=str, default='results/object365_index8.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index8/semi/objects365_label/annotations/object365_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index8/semi/objects365_unlabel/annotations/object365_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index8/objects365_5/Images/train/')
