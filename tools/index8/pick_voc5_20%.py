...
with open('./datasets/two_stage_datasets/index8/voc_07_12_2/Annotations/instances_trainval.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index8/semi/voc5_20%/annotations/instances_trainval_20%.json', 'w'))