...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index9/exdark/annotations/exdark_train.json')
    parser.add_argument("--active-annotation", type=str, default='results/exdark12_index9.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index9/semi/exdark12_label/annotations/exdark12_active_label.json')
    ...
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index9/exdark/images/train/')
