...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/two_stage_datasets/index9/coco12/annotations/instances_train2017.json')
    parser.add_argument("--active-annotation", type=str, default='results/coco12_index9.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index9/semi/coco12_label/annotations/coco12_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index9/semi/coco12_unlabel/annotations/coco12_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/two_stage_datasets/index9/coco12/images/train2017/')
    parser.add_argument("--classes-number", type=str, default=12)
