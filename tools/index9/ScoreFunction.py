...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/index9/coco12_index9.json')
    parser.add_argument("--indicator-file",type=str,default='results/coco12_index9')
