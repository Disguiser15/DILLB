...
with open('./datasets/two_stage_datasets/index9/coco12/annotations/instances_train2017.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index9/semi/coco12_20%/annotations/instances_train2017_20%.json', 'w'))