...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/index1/step2/coco_b/annotations/coco_b.json')
    parser.add_argument("--active-annotation", type=str, default='results/cocobtrain_2step.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index1/step2/semi/cocob_label/annotations/cocob_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index1/step2/semi/cocob_unlabel/annotations/cocob_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/index1/step2/coco_b/images/')
