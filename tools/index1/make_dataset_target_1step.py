...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/index1/step1/coco_a/annotations/coco_a.json')
    parser.add_argument("--active-annotation", type=str, default='results/cocoatrain_1step.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index1/step1/semi/cocoa_label/annotations/cocoa_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index1/step1/semi/cocoa_unlabel/annotations/cocoa_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/index1/step1/coco_a/images/')
