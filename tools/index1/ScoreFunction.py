...
if __name__ == '__main__':
    ...
    parser.add_argument("--static-file",type=str,default='temp/voc07+voc12/static_by_15random.json')
    parser.add_argument("--indicator-file",type=str,default='results/voc07+voc12/15random_maxnorm')
