...
def generate_xml():
    ...
    train_07train_12trainval = train_07train_12trainval_original
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='make voc2007train+voc2012trainval dataset')
    ...
    parser.add_argument("--save-dir",type=str,default='datasets/index1/step1/voc_07_12/')
    parser.add_argument("--dataseed",type=int,default=1)
