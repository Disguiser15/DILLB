...
with open('./datasets/index1/step3/voc+coco_a+coco_b/annotations/voc+coco_a+coco_b.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new, open('./datasets/index1/step3/semi/voc+cocoa+cocob_20%/annotations/voc+coco_a+coco_b_20%.json', 'w'))