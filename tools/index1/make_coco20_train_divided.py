...
with open('./datasets/index1/coco20/annotations/instances_train2017_new.json','r',encoding='utf8')as fp:
...
json.dump(json_data_new1, open('./datasets/index1/step1/coco_a/annotations/coco_a.json', 'w'))
json.dump(json_data_new2, open('./datasets/index1/step2/coco_b/annotations/coco_b.json', 'w'))
json.dump(json_data_new3, open('./datasets/index1/step3/coco_c/annotations/coco_c.json', 'w'))