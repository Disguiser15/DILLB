...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/index1/step3/coco_c/annotations/coco_c.json')
    parser.add_argument("--active-annotation", type=str, default='results/cococtrain_3step.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index1/step3/semi/cococ_label/annotations/cococ_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index1/step3/semi/cococ_unlabel/annotations/cococ_active_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/index1/step3/coco_c/images/')
