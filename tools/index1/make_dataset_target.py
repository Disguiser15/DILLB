...
if __name__=='__main__':
    ...
    parser.add_argument("--input-annotation", type=str, default='datasets/index1/coco20/annotations/instances_train2017_new.json')
    parser.add_argument("--active-annotation", type=str, default='results/coco20train.json')
    parser.add_argument("--output-dir1", type=str, default='datasets/index1/semi/coco20_label/annotations/coco20_active_label.json')
    parser.add_argument("--output-dir2", type=str, default='datasets/index1/semi/coco20_unlabel/annotations/coco20_unlabel.json')
    parser.add_argument("--remove-string", type=str, default='datasets/index1/coco20/images/train2017/')
